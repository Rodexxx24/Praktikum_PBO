...
public class Main {
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (pilihan) {
                ...
                case 2 -> menuPenyewaan(konsolService, transaksiService, penyewaService);
                case 0 -> {
    ...
    private static void menuPenyewaan(KonsolService konsolService, TransaksiService transaksiService, PenyewaService penyewaService) {
        boolean loop = true;
        while (loop) {
            System.out.println("\n--- Daftar Konsol ---");
